...
CALL "C:\Autodesk\Civil_3D\2020\User\C3A_2020.lnk" /b "C:\Autodesk\Civil_3D\2020\Support\openclose.scr"
...
:Start_Civil3D
ie4uinit.exe -show
start "" /b "C:\Autodesk\Civil_3D\2020\User\ESD_C3A_2020_Start.lnk"
EXIT