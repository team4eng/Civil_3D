...
SET _what_C3D2020=/COPY:DAT /E /R:5 /XD Pipe_Network Survey_Database
...
IF NOT EXIST "%userprofile%\AppData\Roaming\Autodesk\AutoCAD 2020\R23.1\enu\Support\acad.cuix" (GOTO :Civil_Setup) ELSE (GOTO :Refresh_Files)

REM Configuration stock Civil 3D for current user

:Civil_Setup

CALL "C:\Autodesk\Civil_3D\2020\User\ACD_2020.lnk" /b "C:\Autodesk\Civil_3D\2020\Support\openclose.scr"
...
REG DELETE "HKEY_CURRENT_USER\Software\Autodesk\AutoCAD\R23.1\ACAD-2001:409\Scale List" /f
...
>> "%Temp%\~import.reg" ECHO [HKEY_CURRENT_USER\Software\Autodesk\AutoCAD\R23.1\ACAD-3001:409\Scale List]
...
:Start_Civil3D
ie4uinit.exe -show
start "" /b "C:\Autodesk\Civil_3D\2020\User\COA_ACD_2020_Start.lnk"
EXIT